...
<section class ="course">
    <section class="course">
        <h1>Кастинги <a href="castings.php"><i class="fa-solid fa-circle-arrow-right" style="font-size: 30px;"></i></a></h1>
    ...
    <section class ="course">
        <h1>Курсы <a href="#"><i class="fa-solid fa-circle-arrow-right" style="font-size: 30px;"></i></a></h1>
        <div class="row">
            <div class="course-col">
                <img src="images/7.jpg" alt="Image">
                <div class="description">
                    <p>Мастрество актерской игры</p>
                </div>
            ...
            <div class="course-col">
                ...
                <div class="description">
                    <p>Ораторское искусство: Введение</p>
                </div>
                <a><i class="fa-solid fa-angle-right"></i></a>
            </div>
        </div>
    ...
    <section class ="course">
        <h1>Статьи <a href="#"><i class="fa-solid fa-circle-arrow-right" style="font-size: 30px;"></i></a></h1>
        <div class="row">
            <div class="course-col">
                <img src="images/6.jpg" alt="Image">
                <div class="description">
                    <p>Мир моделинга: где Грация встречает индиви..</p>
                </div>
                <a><i class="fa-solid fa-angle-right"></i></a>
            </div>
            <div class="course-col">
                ...
                <div class="description">
                    <p>Манекены Vs Модели: кто завоюет сердца п...</p>
                </div>
                <a><i class="fa-solid fa-angle-right"></i></a>
            </div>
        </div>
